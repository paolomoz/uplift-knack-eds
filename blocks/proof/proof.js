/**
 * proof — social-proof / trust strip. Lifted from the stardust prototype
 * <section class="proof wrap"> on solution-proposed.html: a centered
 * "Trusted by…" line above a grayscale row of customer / logo names.
 *
 * Authoring rows (positional):
 *   1. the "Trusted by …" line (plain text)
 *   2. a list (<ul><li>…</li></ul>) of logo names — each <li> becomes a
 *      grayscale name span. (Comma/newline-separated text also accepted.)
 */
